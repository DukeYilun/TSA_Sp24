...
```{r}
#When there is only two terms, it means there is d = -, no differencing.
...
#residual is estimate - observed, fitted is the closet estimate
#We hope residual to be white noise, around the 0 mean and showing no serial correlation, so it should be insignificant.
#Drift is the intercept terms. ar1 ar2 is the coefficient of ar term1 or term2. ma1 is the coefficient of ma term1.
#aic should be as low as possible.
...
#lower case max.pdq is for nonseasonal, PDQ is for seasonal. Here is to set there is no seasonal components since it's deseasoned.  
print(Model_autofit)
...
#Can set D as 0 if you differenced it before.

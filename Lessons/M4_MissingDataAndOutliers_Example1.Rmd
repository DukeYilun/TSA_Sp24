...
#Remove last four rows by replacing current data frame
...
#When you think magnitude is changing over time, then you might need multiplicated model
...
#tsclean will remove and replace outliers and missing values with period mean
...
autoplot(ts_inflow_random,series="Random")+
  ...
  geom_abline(slope=0,intercept=3*sd_inflow)+
  geom_abline(slope=0,intercept=-3*sd_inflow)
